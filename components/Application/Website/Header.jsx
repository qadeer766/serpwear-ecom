    ...
    <div className="bg-white border-b lg:px-32 px-4">
      <div className="flex justify-between items-center lg:py-5 py-3">
        ...
        <div className="flex justify-between gap-20">
          <nav className={`lg:relative lg:w-auto lg:top-0 lg:left-0 lg:p-0 bg-white fixed z-50  lg:h-auto top-0 w-full h-screen transition-all ${isMobileMenu ? 'left-0' : '-left-full'}`}>
